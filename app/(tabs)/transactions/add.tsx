...
type Category = 'Food' | 'Transport' | 'Shopping' | 'Bills' | 'Salary' | 'Investment';
...
export default function AddTransactionScreen() {
  ...
  const categories: Category[] = ['Food', 'Transport', 'Shopping', 'Bills', 'Salary', 'Investment'];
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.sourceContainer}>
            {sources.map((src) => (
              ...
              >
                <Text
                  style={[styles.sourceChipText, source === src && styles.sourceChipTextActive]}
                >
